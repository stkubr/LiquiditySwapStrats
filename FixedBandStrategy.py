...
class FixedBandStrategy:
    ...
    def set_liquidity_ranges(self,current_strat_obs):
        ...
        strategy_info = dict()
        strategy_info['reset_range_lower'] = current_strat_obs.price*(1 - self.alpha_param)
        strategy_info['reset_range_upper'] = current_strat_obs.price*(1 + self.alpha_param)

        # Set the base range
        base_range_lower = current_strat_obs.price*(1 - self.tau_param)
        base_range_upper = current_strat_obs.price*(1 + self.tau_param)
